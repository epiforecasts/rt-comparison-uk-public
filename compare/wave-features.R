...
region_names <- source("utils/utils.R")
...
all_wave <- list(
  cases = purrr::map(summary_group, ~ wave_features(.x, "median_cases_blend", 7)),
  hosp = purrr::map(summary_group, ~ wave_features(.x, "median_cases_hosp", 7)),
  deaths = purrr::map(summary_group, ~ wave_features(.x, "median_deaths_blend", 7)))
...
cases_median_mean <- mean_over_series(median, "median_cases_blend")
hosp_median_mean <- mean_over_series(median, "median_cases_hosp")
deaths_median_mean <- mean_over_series(median, "median_deaths_blend")
...
c(t.test(median_region$median_cases_blend)$estimate, 
  t.test(median_region$median_cases_blend)$conf.int)
c(t.test(median_region$median_cases_hosp)$estimate,
  t.test(median_region$median_cases_hosp)$conf.int)
c(t.test(median_region$median_deaths_blend)$estimate,
  t.test(median_region$median_deaths_blend)$conf.int)

lower90_region <- dplyr::filter(lower90, region %in% region_names$value$nhsregions)
c(t.test(lower90_region$lower_90_cases_blend)$estimate, 
  t.test(lower90_region$lower_90_cases_blend)$conf.int)
c(t.test(lower90_region$lower_90_cases_hosp)$estimate,
  t.test(lower90_region$lower_90_cases_hosp)$conf.int)
c(t.test(lower90_region$lower_90_deaths_blend)$estimate,
  t.test(lower90_region$lower_90_deaths_blend)$conf.int)

upper90_region <- dplyr::filter(upper90, region %in% region_names$value$nhsregions)
c(t.test(upper90_region$upper_90_cases_blend)$estimate, 
  t.test(upper90_region$upper_90_cases_blend)$conf.int)
c(t.test(upper90_region$upper_90_cases_hosp)$estimate,
  t.test(upper90_region$upper_90_cases_hosp)$conf.int)
c(t.test(upper90_region$upper_90_deaths_blend)$estimate,
  t.test(upper90_region$upper_90_deaths_blend)$conf.int)
